(function() {
  var buildFile, buildTarget, checkLegalProject, config, current, cwd, doBuildCommon, doBuildCompileHbs, doBuildCopy, doBuildIgnore, end, getBuildList, isReg, prepareConfig, replaceFileExt, _fse, _handlebar, _path, _utils_file;
  ...
  getBuildList = function() {
    return [doBuildIgnore, doBuildCompileHbs, doBuildCopy];
  };
