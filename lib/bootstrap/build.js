(function() {
  var buildFile, buildTarget, checkLegalProject, config, current, cwd, doBuildCommon, doBuildCompileHbs, doBuildCopy, doBuildIgnore, doBuildLess, end, getBuildList, isReg, prepareConfig, replaceFileExt, _coffee, _fs, _fse, _handlebar, _less, _path, _utils_file;
  ...
  doBuildLess = function(filename, buildFilename, next) {
    var buildConfig, factory;
    factory = function(filename) {
      var buildTargetFilePath, buildTargetFilename, content;
  ...
  getBuildList = function() {
    return [doBuildIgnore, doBuildCompileHbs, doBuildLess, doBuildCopy];
  };
