(function() {
  var $buildTarget, $config, doBuildCopy, doBuildIgnore, getModuleList, initVariable, prepareConfig, _, _fs, _fse, _path, _sload;
  ...
  initVariable = function() {
    ...
    return $buildTarget = SLOW._config_.build.target;
  };
