...
(function() {
  var File, compressibleQueue, initCompressibleQueue, _chokidar, _fs, _glob, _mime, _path, _util_string;
  ...
  File.getAllFile = function(dir, filesQueue) {
    var files, i, name;
    filesQueue = filesQueue || [];
    if (typeof filesQueue === "undefined") {
      filesQueue = [];
    }
  ...
  File.replaceFileExt = function(filename, ext) {
