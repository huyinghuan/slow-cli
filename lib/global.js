(function() {
  var $defaultConfigDirectoryPath, $defaultConfigFilePath, $defaultDemoDirectory, $defaultRuntimeConfigureFilePath, $defaultRuntimeDirectory, $identity, $identityFile, $identityFilePath, initBuildGlobalConfig, initInitGlobalConfig, initRuntimeGlobalConfig, initSampleGlobalConfig, pkg, version, _fs, _path, _pathJudge;
  ...
  initSampleGlobalConfig = function(program, setting) {
  ...
  module.exports = function(program) {
    ...
    if (!_fs.existsSync($defaultRuntimeConfigureFilePath)) {
    ...
    if (program.start) {
      ...
      return initSampleGlobalConfig(program, setting);
    }
  };
